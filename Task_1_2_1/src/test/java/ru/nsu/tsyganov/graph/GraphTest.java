...
class GraphTest {
    ...
    void otherTypesTest() throws URISyntaxException {
        ...
        Edge<Integer, Integer> edge12 =
                new Edge<Integer, Integer>(vertex1, vertex2, 12, (double) 1);
        Edge<Integer, Integer> edge13 =
                new Edge<Integer, Integer>(vertex1, vertex3, 12, (double) 2);
        Edge<Integer, Integer> edge24 =
                new Edge<Integer, Integer>(vertex2, vertex4, 12, (double) 3);
